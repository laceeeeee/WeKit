...
@Feature(
    name = "悬浮标题栏",
    categories = ["聊天"],
    description = "将聊天界面顶部的标题栏及标题下方挂件 (如置顶消息) 改为悬浮卡片, 支持圆角、阴影和侧边距",
)
        ...
        showComposeDialog(context) {
            ...
            AlertDialogContent(
                ...
                text = {
                    DefaultColumn {
                        ListItem(
                            content = { Text("重新打开聊天后生效") },
                            supportingContent = {
                                Text("将标题栏及下方的置顶消息等卡片显示为悬浮卡片")
                            }
                        )
                        ListItem(
                            content = {
                                Text("圆角: ${cornerInput.roundToInt()} dp")
                            },
                            supportingContent = {
                                Slider(
                                    value = cornerInput,
                        ...
                        ListItem(
                            content = {
                                Text("侧边距: ${sideInput.roundToInt()} dp")
                            },
                            supportingContent = {
                                Slider(
                                    value = sideInput,
                        ...
                        ListItem(
                            content = {
                                Text("顶部间距: ${gapInput.roundToInt()} dp")
                            },
                            supportingContent = {
                                Slider(
                                    value = gapInput,
                        ...
                        ListItem(
                            content = {
                                Text("卡片下方间距: ${extraGapInput.roundToInt()} dp")
                            },
                            supportingContent = {
                                Slider(
                                    value = extraGapInput,
                        ...
                        ListItem(
                            content = {
                                Text("阴影强度: ${elevInput.roundToInt()} dp")
                            },
                            supportingContent = {
                                Slider(
                                    value = elevInput,
